...
{
    public class OracleDbContextOptionBuilder : DbContextOptionBuilder<LinqToDbConnectionOptions>
    {
        private readonly IDbContextOptionBuilder<LinqToDbConnectionOptions> dbContextOptionBuilder;
        private readonly IUnitOfWork _unitOfWork;

        public OracleDbContextOptionBuilder(IDbContextOptionBuilder<LinqToDbConnectionOptions> dbContextOptionBuilder, IUnitOfWork unitOfWork)
        {
        ...
        public override DbContextOption<LinqToDbConnectionOptions> Build()
        {
            ...
            var dbProvider = Linq2DBMap.GetDataProvider(LinqToDB.ProviderName.OracleManaged, connection.ConnectionString);
            ...
            .AddOrUpdateExtension(new OracleDbContextOptionExtensions()).Build();
            return that;
        }
    }
}
