...
@Component
export default class assignRoles extends Controller {
    ...
    async gridData1(params) {
        params = Object.assign({ UserId: this.ID }, params);
        let res = await this.$http({
            method: "post",
            url: "/api/services/SysMgrBussenssModule/SysRoleInfo/GetUserNotRoleList",
            data: params
        });
    ...
    async gridData2(params) {
        ...
        let res = await this.$http({
            method: "post",
            url: "/api/services/SysMgrBussenssModule/SysRoleInfo/GetUserAuList",
            data: params
        });
    ...
    async saveClick() {
        ...
        let res = await this.$http({
            method: "post",
            url: "/api/services/SysMgrBussenssModule/SysUserInfo/SaveRoleUser",
            data: params
        });
