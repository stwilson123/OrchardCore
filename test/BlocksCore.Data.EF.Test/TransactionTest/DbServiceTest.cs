...
namespace BlocksCore.Data.EF.Test.TransactionTest
{
    public class DbServiceTest : IClassFixture<ServiceTestContextFix<WebApiTestApplication.Startup>>, IClassFixture<DbModelContextFixs>
    {
        ...
        public DbServiceTest(ServiceTestContextFix<WebApiTestApplication.Startup> serviceTestContextFix, DbModelContextFixs testModelContext)
        {
