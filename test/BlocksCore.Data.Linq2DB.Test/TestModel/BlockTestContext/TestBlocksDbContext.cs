...
//        static string providerConvert(string providerName)
//        {
//            return string.Equals(providerName, "sqlserver", System.StringComparison.InvariantCultureIgnoreCase) ? "Microsoft.Data.SqlClient" : "";
//        }

//        public TestBlocksDbContext(BlocksDbContextOption blocksDbContextOption) : base(null, null,null,
//            new DbContextOption<LinqToDbConnectionOptions>( new LinqToDbConnectionOptions(new LinqToDbConnectionOptionsBuilder().UseConnectionString(providerConvert(blocksDbContextOption.ProviderName),blocksDbContextOption.ConnectString)), null), 
//            new ServiceProviderCache(null))
//        {
